...
def enrich_with_50a(page, record):
    ...
    record.update({
        ...
        "Settlement": "0",  # placeholder if needed
        "Last Earned": "0", # placeholder if payroll not used yet
    })
...
with csv_path.open("w", newline="", encoding="utf-8") as f:
    fieldnames = ["Date","Time","Rank","First","Last","Room","Case Type","Allegations","Lawsuits","Settlement","Last Earned"]
