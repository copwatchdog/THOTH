...
SITES = {
    ...
    "COMPLAINT": "https://data.cityofnewyork.us/Public-Safety/Civilian-Complaint-Review-Board-Complaints-Against/2mby-ccnw/data_preview",
    "ALLEGATIONS": "https://data.cityofnewyork.us/Public-Safety/Civilian-Complaint-Review-Board-Allegations-Agains/6xgr-kwjq/data_preview",
    "POLICE": "https://data.cityofnewyork.us/Public-Safety/Civilian-Complaint-Review-Board-Police-Officers/2fir-qns4/data_preview",
    "PENALTIES": "https://data.cityofnewyork.us/Public-Safety/Civilian-Complaint-Review-Board-Penalties/keep-pkmh/data_preview"
}
...
fieldnames = [
    ...
    "badge","precinct_number","precinct_link","service_start","last_earned",
    "has_discipline","has_articles",
    "num_complaints","num_allegations","num_substantiated","num_substantiated_charges",
    "num_unsubstantiated","num_within_guidelines",
    "num_lawsuits","total_settlements",
    "Base Salary","Pay Basis","Regular Hours","Regular Gross Paid","OT Hours","Total OT Paid","Total Other Pay"
]

for file_name in ["nypdtrial.csv", "50a.csv", "payroll.csv"]:
    ...
    with csv_path.open("w", newline="", encoding="utf-8") as f:
        ...
        for r in all_records:
            writer.writerow({
                ...
                "badge": r.get("badge",""),
                "precinct_number": r.get("precinct_number",""),
                "precinct_link": r.get("precinct_link",""),
                "service_start": r.get("service_start",""),
                "last_earned": r.get("last_earned",""),
                "has_discipline": r.get("has_discipline","N"),
                "has_articles": r.get("has_articles","N"),
                "num_complaints": r.get("num_complaints",0),
                "num_allegations": r.get("num_allegations",0),
                "num_substantiated": r.get("num_substantiated",0),
                "num_substantiated_charges": r.get("num_substantiated_charges",0),
                "num_unsubstantiated": r.get("num_unsubstantiated",0),
                "num_within_guidelines": r.get("num_within_guidelines",0),
                "num_lawsuits": r.get("num_lawsuits",0),
                "total_settlements": r.get("total_settlements",0),
